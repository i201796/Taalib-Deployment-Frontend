...
function CourseForm() {
    ...
    const getTeachers = async () => {
      try {
        ...
        const response = await axios.get(
          "https://taalib-api.onrender.com/academicOfficers/getAllTeachers",
          {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://taalib-api.onrender.com/academicOfficers/addCourse",
        course,
        {
          headers: { token: token.token },
        }
  ...
  const addCourseToTeacher = async (course, teacherId) => {
    ...
    try {
      const token = JSON.parse(localStorage.getItem("user"));
      await axios.post(
        "https://taalib-api.onrender.com/academicOfficers/addCourseToTeacher",
        { course, teacher },
        {
          headers: { token: token.token },
        }
